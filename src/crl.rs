...
impl RevokedCertificate {
    ...
    #[getter]
    pub fn expired_at(&self) -> i64 { self.expired_at }

    pub fn __repr__(&self) -> String {
        format!("<RevokedCertificate S/N \"{}\" reason={:?}>", self.serial_number, self.reason)
    }
}
...
impl CertificateRevocationList {
                    ...
                    revoked_list.push(
                        RevokedCertificate {
                            ...
                            reason: match reason {
                                ...
                                InternalCode::CessationOfOperation => ReasonFlags::cessation_of_operation,
    ...
    pub fn is_revoked<'a>(&self, serial_number: String) -> Option<RevokedCertificate> {
    ...
    #[getter]
    pub fn next_update_at(&self) -> i64 { self.next_update_at }

    #[getter]
    pub fn last_updated_at(&self) -> i64 { self.last_updated_at }
